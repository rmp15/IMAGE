...
% GENERALISE TO ANY VARIABLE NAME AS IT'S CLUMSY RIGHT NOW
tasmax_s_fn = strcat(sroot,'tasmax/processed/',savefilename,'_tasmax_s');
tasmax_o_fn = strcat(sroot,'tasmax/processed/',savefilename,'_tasmax_o');
tasmax_s = mv(1).s;
tasmax_o = mv(1).o;
