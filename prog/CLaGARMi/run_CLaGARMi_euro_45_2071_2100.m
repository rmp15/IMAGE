...
% fix the following
load data/CORDEX_nobc_clagarm_input/tasmax_MPI_nobc_4520712100.mat
mv(1)=v;
load data/CORDEX_nobc_clagarm_input/appt_MPI_nobc_4520712100.mat
mv(2)=v;
clear v
...
savefilename = strcat(sroot,'out_',num2str(split,'%02d'),'_y',int2str(nyrs),'_euro_45_2071_2100');
