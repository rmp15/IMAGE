function output=CORDEX_input_file_creator_europe_heatwave(variable_name,lbound,ubound,file_prefix,start_year,end_year,save_file_suffix)
...
for i = 1:65
    for j = 1:39
        old_i_coord = (i*4)-2;
        old_j_coord = (j*4)-2;
        new_lats(i,j) = model_lats(old_i_coord,old_j_coord);
        new_lons(i,j) = model_lons(old_i_coord,old_j_coord);
