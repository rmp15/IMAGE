...
#nohup matlab -nosplash -nodesktop -softwareopengl -r run_CLaGARMi_euro_hist_pr_ps_6000yr;
nohup matlab -nosplash -nodesktop -softwareopengl -r run_CLaGARMi_euro_hist_pr_ps_4000yr;
